...
public class HomeController {
	...
	// 파라미터로 넘어오는 데이터의 키값과 command객체의 멤버변수의 이름이 같으면 그 멤버변수에 데이터의 값이 입력됨
	...
	// 백단에서 화면단으로 데이터 전송
	// 1. Model객체를 이용
	// model: 키는 String, 값은 Object로 되어있어서 어떠한 형태의 값이던지 전송 가능
	@GetMapping("/hello.do")
...
//		model.addAttribute("list", mapList);
		...
		// 로그인한 유저의 정보를 담아주거나 현재 연결되어있는 세션의 정보를 담아줄 때 사용
